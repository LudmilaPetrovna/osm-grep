...
inline ::google::protobuf::int64 Way::lat(int index) const {
  // @@protoc_insertion_point(field_get:OSMPBF.Way.lat)
  return lat_.Get(index);
}
inline void Way::set_lat(int index, ::google::protobuf::int64 value) {
  lat_.Set(index, value);
  // @@protoc_insertion_point(field_set:OSMPBF.Way.lat)
}
inline void Way::add_lat(::google::protobuf::int64 value) {
  lat_.Add(value);
...
inline ::google::protobuf::int64 Way::lon(int index) const {
  // @@protoc_insertion_point(field_get:OSMPBF.Way.lon)
  return lon_.Get(index);
}
inline void Way::set_lon(int index, ::google::protobuf::int64 value) {
  lon_.Set(index, value);
  // @@protoc_insertion_point(field_set:OSMPBF.Way.lon)
}
inline void Way::add_lon(::google::protobuf::int64 value) {
  lon_.Add(value);
